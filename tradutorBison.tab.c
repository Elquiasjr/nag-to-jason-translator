...
#line 1 "tradutorBison.y"

#include <stdio.h>
#include <stdlib.h>
#include "tradutorHeader.h"

#line 77 "tradutorBison.tab.c"
...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_CRENCAS = 4,                    /* CRENCAS  */
  YYSYMBOL_OBJETIVOS = 5,                  /* OBJETIVOS  */
  YYSYMBOL_PLANOS = 6,                     /* PLANOS  */
  YYSYMBOL_OU = 7,                         /* OU  */
  YYSYMBOL_NAO = 8,                        /* NAO  */
  YYSYMBOL_E = 9,                          /* E  */
  YYSYMBOL_10_ = 10,                       /* '{'  */
...
{
       0,    34,    34,    35,    39,    44,    47,    48,    51,    54,
      55,    58,    61,    62,    65,    68,    71,    72,    73,    76,
      77,    78,    81,    84,    85
};
#endif
